...
async function POST(req) {
    try {
        ...
        const { name, company, email, phone, reason, message, subscribe } = body;
        // Basic validations
      ...
      <p>${message.replace(/\n/g, "<br>")}</p>
      <hr>
      <p><strong>Mailing List Opt-In:</strong> ${subscribe ? "YES" : "NO"}</p>
    `;
        // Send email via Resend
        await resend.emails.send({
            from: "DealsWindfall <no-reply@dealswindfall.com>",
            to: process.env.CONTACT_EMAIL,
            subject: `New Contact Form Submission – ${reason}`,
            html
        });
        // OPTIONAL: Store in Supabase (I can generate code if you want)
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
